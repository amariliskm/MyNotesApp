...
import com.example.mynotesapp.CustomOnClickListener
...
class NoteAdapter(private val activity: Activity) : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NoteViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_note, parent, false) //proses inflate layout yang dibuat sebelumnya untuk menjadi tampilan per baris di RecyclerView. T
